...
#define yyparse         parser_ord_parse
#define yylex           parser_ord_lex
#define yyerror         parser_ord_error
#define yydebug         parser_ord_debug
#define yynerrs         parser_ord_nerrs
#define yylval          parser_ord_lval
#define yychar          parser_ord_char

/* First part of user prologue.  */
#line 1 "ord_grammar.y"
...
#ifndef YY_PARSER_ORD_Y_TAB_H_INCLUDED
# define YY_PARSER_ORD_Y_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 79 "ord_grammar.y"

  node_ptr node;

#line 227 "ord_grammar.c"
...
#endif /* !YY_PARSER_ORD_Y_TAB_H_INCLUDED  */
...
{
       0,   104,   104,   108,   109,   115,   115,   120,   130,   135,
     140,   149
};
#endif
...
{
  "$end", "error", "$undefined", "LB", "RB", "ATOM", "NUMBER", "DOT",
  "MINUS", "$accept", "begin", "vars_list", "vars_list_item", "$@1",
  "var_id", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 104 "ord_grammar.y"
                          { }
#line 1399 "ord_grammar.c"
    break;

  case 3:
#line 108 "ord_grammar.y"
                {}
#line 1405 "ord_grammar.c"
    break;

  case 4:
#line 110 "ord_grammar.y"
                {
                  parser_ord_add_var(parser_ord_get_global_parser(), (yyvsp[-1].node));
                }
#line 1413 "ord_grammar.c"
    break;

  case 5:
#line 115 "ord_grammar.y"
                 { _is_main_var = true; }
#line 1419 "ord_grammar.c"
    break;

  case 6:
#line 115 "ord_grammar.y"
                                                 { (yyval.node) = (yyvsp[0].node); }
#line 1425 "ord_grammar.c"
    break;

  case 7:
#line 120 "ord_grammar.y"
                 {
              if (_is_main_var) {
...
#line 1471 "ord_grammar.c"
    break;

  case 11:
#line 150 "ord_grammar.y"
                   {
                     (yyval.node) = parser_ord_mk_dot(parser_ord_get_global_parser(), 
                                            (yyvsp[-2].node), (yyvsp[0].node));
                   }
#line 1480 "ord_grammar.c"
    break;


#line 1484 "ord_grammar.c"
